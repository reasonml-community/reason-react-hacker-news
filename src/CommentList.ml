...
type rec action = Toggle(option<string>)

type rec state = {collapsed_comments: Set.Int.t}
        ...
        | StoryData.CommentPresent(comment) =>
          ...
          <div className="CommentList_comment">
            <div
              ...
              <img
                alt={switch openComment {
                | true => "hide"
                | false => "show"
                }}
                src={switch openComment {
                | true => requireAssetURI("src/disclosure90.png")
                | false => requireAssetURI("src/disclosure.png")
                }}
